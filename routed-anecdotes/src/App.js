...
const Menu = () => {
  ...
  return (
    <div>
      <Link to="/">
        <div style={padding}>anecdotes</div>
      </Link>
      <Link to="anecdotes">
        <div style={padding}>anecdotes List</div>
      </Link>
      <Link to="about">
        <div style={padding}> about</div>
      </Link>
      <Link to="create">
        <div style={padding}> create new</div>
      </Link>
    </div>
  );
};
...
const Anecdote = ({
  anecdote: { author = "", content = "", info = "", votes = 0 },
}) => {
  return (
    <div>
      <h1>
